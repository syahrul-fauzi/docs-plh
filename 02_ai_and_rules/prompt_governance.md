...
* **Derived From**: 00_foundation/README.md, 01_architecture/system_overview.md, 03_product_features/core_features_spec.md

---

## 1. Tujuan Dokumen

Dokumen ini mendefinisikan **kerangka tata kelola (governance)** untuk seluruh interaksi AI (CopilotKit) di Lawyers Hub, memastikan bahwa:
...
* 03_features/core_features_spec.md
