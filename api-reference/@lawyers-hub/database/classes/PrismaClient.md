...
[@lawyers-hub/database](../README.md) / PrismaClient

# Class: PrismaClient\<ClientOptions, U, ExtArgs\>

Defined in: node_modules/.prisma/client/index.d.ts:106
...
`ClientOptions` _extends_
[`PrismaClientOptions`](../namespaces/Prisma/interfaces/PrismaClientOptions.md)
=
...
`U` = `"log"` _extends_ keyof `ClientOptions` ? `ClientOptions`\[`"log"`\]
_extends_ ([`LogLevel`](../namespaces/Prisma/type-aliases/LogLevel.md) \|
[`LogDefinition`](../namespaces/Prisma/type-aliases/LogDefinition.md))[] ?
[`GetEvents`](../namespaces/Prisma/type-aliases/GetEvents.md)\<`ClientOptions`\[`"log"`\]\>
: `never` : `never`
...
> **new PrismaClient**\<`ClientOptions`, `U`, `ExtArgs`\>(`optionsArg?`):
> `PrismaClient`\<`ClientOptions`, `U`, `ExtArgs`\>

Defined in: node_modules/.prisma/client/index.d.ts:128
...
[`Subset`](../namespaces/Prisma/type-aliases/Subset.md)\<`ClientOptions`,
[`PrismaClientOptions`](../namespaces/Prisma/interfaces/PrismaClientOptions.md)\>
...
> **$extends**: `ExtendsHook`\<`"extends"`,
> [`TypeMapCb`](../namespaces/Prisma/interfaces/TypeMapCb.md), `ExtArgs`\>

Defined in: node_modules/.prisma/client/index.d.ts:213
...
Defined in: node_modules/.prisma/client/index.d.ts:343
...
Defined in: node_modules/.prisma/client/index.d.ts:293
...
Defined in: node_modules/.prisma/client/index.d.ts:253
...
Defined in: node_modules/.prisma/client/index.d.ts:283
...
> **get** **complianceReview**():
> [`ComplianceReviewDelegate`](../namespaces/Prisma/interfaces/ComplianceReviewDelegate.md)\<`ExtArgs`\>

Defined in: node_modules/.prisma/client/index.d.ts:353

`prisma.complianceReview`: Exposes CRUD operations for the **ComplianceReview**
model.
...
Defined in: node_modules/.prisma/client/index.d.ts:263
...
Defined in: node_modules/.prisma/client/index.d.ts:323

`prisma.documentTemplate`: Exposes CRUD operations for the **DocumentTemplate**
model.
...
Defined in: node_modules/.prisma/client/index.d.ts:273
...
Defined in: node_modules/.prisma/client/index.d.ts:313
...
Defined in: node_modules/.prisma/client/index.d.ts:363
...
Defined in: node_modules/.prisma/client/index.d.ts:233
...
Defined in: node_modules/.prisma/client/index.d.ts:333

`prisma.templateVersion`: Exposes CRUD operations for the **TemplateVersion**
model.
...
Defined in: node_modules/.prisma/client/index.d.ts:223
...
Defined in: node_modules/.prisma/client/index.d.ts:303
...
Defined in: node_modules/.prisma/client/index.d.ts:243
...
Defined in: node_modules/.prisma/client/index.d.ts:134
...
Defined in: node_modules/.prisma/client/index.d.ts:139
...
> **$executeRaw**\<`T`\>(`query`, ...`values`):
> [`PrismaPromise`](../namespaces/Prisma/type-aliases/PrismaPromise.md)\<`number`\>

Defined in: node_modules/.prisma/client/index.d.ts:157
...
> **$executeRawUnsafe**\<`T`\>(`query`, ...`values`):
> [`PrismaPromise`](../namespaces/Prisma/type-aliases/PrismaPromise.md)\<`number`\>

Defined in: node_modules/.prisma/client/index.d.ts:169

Executes a raw query and returns the number of affected rows. Susceptible to SQL
injections, see documentation.
...
Defined in: node_modules/.prisma/client/index.d.ts:129
...
> **$queryRaw**\<`T`\>(`query`, ...`values`):
> [`PrismaPromise`](../namespaces/Prisma/type-aliases/PrismaPromise.md)\<`T`\>

Defined in: node_modules/.prisma/client/index.d.ts:180
...
> **$queryRawUnsafe**\<`T`\>(`query`, ...`values`):
> [`PrismaPromise`](../namespaces/Prisma/type-aliases/PrismaPromise.md)\<`T`\>

Defined in: node_modules/.prisma/client/index.d.ts:192

Performs a raw query and returns the `SELECT` data. Susceptible to SQL
injections, see documentation.
...
Defined in: node_modules/.prisma/client/index.d.ts:208

Allows the running of a sequence of read/write operations that are guaranteed to
...
`P` _extends_
[`PrismaPromise`](../namespaces/Prisma/type-aliases/PrismaPromise.md)\<`any`\>[]
...
Defined in: node_modules/.prisma/client/index.d.ts:210
...
Defined in: node_modules/.prisma/client/index.d.ts:146
