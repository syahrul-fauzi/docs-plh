...
Defined in: node_modules/.prisma/client/index.d.ts:4848
...
Defined in: node_modules/.prisma/client/index.d.ts:4867
...
Defined in: node_modules/.prisma/client/index.d.ts:4849
...
Defined in: node_modules/.prisma/client/index.d.ts:4850
...
> `string`; `fullName`: `string`; `id`: `string`; `role`: `string`; `tenantId`:
> `string`; `updatedAt`: `Date`; \}, `ExtArgs`\[`"result"`\]\[`"user"`\]\>

Defined in: node_modules/.prisma/client/index.d.ts:4858
