...
[Lawyers Hub API Reference](../../../../../packages.md) / [@lawyers-hub/database](../../../README.md) / [Prisma](../README.md) / Prisma\_\_DraftClient

# Interface: Prisma\_\_DraftClient\<T, Null, ExtArgs\>

Defined in: node\_modules/.prisma/client/index.d.ts:8376
...
Defined in: node\_modules/.prisma/client/index.d.ts:8377
...
Defined in: node\_modules/.prisma/client/index.d.ts:8379

#### Type Parameters

##### T

`T` *extends* [`Draft$caseArgs`](../type-aliases/Draft$caseArgs.md)\<`ExtArgs`\> = \{ \}

#### Parameters

##### args?

[`Subset`](../type-aliases/Subset.md)\<`T`, [`Draft$caseArgs`](../type-aliases/Draft$caseArgs.md)\<`ExtArgs`\>\>
...
Defined in: node\_modules/.prisma/client/index.d.ts:8393
...
Defined in: node\_modules/.prisma/client/index.d.ts:8378

#### Type Parameters

##### T

`T` *extends* [`Draft$commentsArgs`](../type-aliases/Draft$commentsArgs.md)\<`ExtArgs`\> = \{ \}

#### Parameters

##### args?

[`Subset`](../type-aliases/Subset.md)\<`T`, [`Draft$commentsArgs`](../type-aliases/Draft$commentsArgs.md)\<`ExtArgs`\>\>
...
Defined in: node\_modules/.prisma/client/index.d.ts:8400
...
Defined in: node\_modules/.prisma/client/index.d.ts:8380
...
Defined in: node\_modules/.prisma/client/index.d.ts:8387
