...
[Lawyers Hub API Reference](../../packages.md) / @lawyers-hub/auth
...
- [detectPII](functions/detectPII.md)
- [detectPIIWithPresidio](functions/detectPIIWithPresidio.md)
- [encrypt](functions/encrypt.md)
- [generateKey](functions/generateKey.md)
- [maskPII](functions/maskPII.md)
- [maskPIIAsync](functions/maskPIIAsync.md)
- [signToken](functions/signToken.md)
- [unmaskPII](functions/unmaskPII.md)
