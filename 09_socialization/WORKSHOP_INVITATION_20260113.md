...
## 2. Isi Undangan (Email Body)

**Subject**: 🚀 [Workshop] Transformasi Dokumentasi Enterprise Lawyers Hub

Halo Tim,

Seiring dengan pertumbuhan Lawyers Hub menuju skala enterprise, kita mengadopsi
...
- **Waktu**: 10:00 - 12:00 WIB
- **Lokasi/Link**: Ruang Meeting Utama (Lantai 5) / [Link Zoom Placeholder]
- **Peserta Wajib**: Tim Engineering, Tim Legal, Product Managers.
...
1. **Memahami 9 Pilar**: Struktur folder baru untuk skalabilitas dokumen.
2. **Hands-on Rule PRD**: Tim Legal akan mencoba mendokumentasikan aturan hukum
   nyata.
3. **Validasi CI/CD**: Tim Engineering akan melihat alur otomasi kualitas
   dokumen.

Kehadiran rekan-rekan sangat penting untuk kelancaran transisi sistem kita.
...
- **10:00 - 10:15**: Pembukaan & Visi Dokumentasi v1.0.
- **10:15 - 10:45**: Bedah Arsitektur 9 Pilar (Struktur & Navigasi).
- **10:45 - 11:30**: Sesi Breakout (Hands-on Rule PRD vs CI/CD Sync).
- **11:30 - 12:00**: Tanya Jawab & Rencana Transisi.
