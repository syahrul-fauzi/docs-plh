...
- **Drafting**: Menghasilkan dokumen hukum yang mematuhi aturan (mandatory
  clauses).
- **Multi-tenancy**: Admin tenant dapat mengelola user dalam organisasinya tanpa
  akses ke organisasi lain.
