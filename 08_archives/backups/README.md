...
3. **Mulai menulis dokumentasi:** Buka folder `docs/` dan tambahkan file `.md`
   baru.

4. **Format dokumen:** Jalankan perintah berikut untuk merapikan format:
...
Kami sangat menghargai kontribusi Anda! Silakan baca
[CONTRIBUTING.md](CONTRIBUTING.md) untuk detail lebih lanjut mengenai alur kerja
kami.
