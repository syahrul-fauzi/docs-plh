...
Sistem dianggap siap untuk rilis produksi (Go-Live) apabila memenuhi kriteria berikut:
...
4. [ ] Sistem otentikasi (Clerk) berfungsi untuk semua role (Admin, Lawyer, Staff).

## 🔒 Kriteria Keamanan & Kepatuhan
1. [ ] Deteksi PII (KTP, NPWP, Rekening) memiliki akurasi minimal 95%.
2. [ ] Kebijakan RLS (Row Level Security) memastikan isolasi data antar tenant.
