...
Fase ini mengimplementasikan sistem penagihan (billing) dan manajemen langganan
(subscription) menggunakan Stripe. Sistem ini memungkinkan firma hukum untuk
memilih paket layanan (Free, Pro, Enterprise).

## Komponen Utama

### 1. Database (Prisma)

- **Subscription Model**: Menyimpan status langganan, ID pelanggan Stripe, ID
  harga Stripe, dan masa berlaku paket.
