...
- **Shift-Left Performance**: Jalankan load test sederhana di tahap development,
  bukan hanya di akhir siklus.
- **Realistic Data Volume**: Pastikan database staging memiliki volume data yang
  mirip dengan produksi.
- **Breakpoint Testing**: Lakukan _stress test_ untuk mengetahui di titik mana
