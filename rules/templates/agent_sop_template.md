...
## 1. Tujuan
*Panduan ini menjelaskan cara berinteraksi dengan [Nama Agent] untuk tugas [Sebutkan Tugas].*
...
> "Buatkan [Jenis Dokumen] untuk klien [Nama Klien] melawan [Pihak Lawan] dengan poin-poin kesepakatan berikut: [Daftar Poin]."
...
**Don'ts (Jangan):**
*   Jangan memasukkan data pribadi sensitif (NIK, No. Rekening) secara langsung di prompt (gunakan placeholder).
...
## 5. Eskalasi
Jika menemukan kesalahan fatal (halusinasi hukum berat), segera laporkan melalui tombol "Report Issue" atau email ke [support-email].
