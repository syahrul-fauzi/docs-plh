...
kerangka kerja *Orchestrated Multi-Agent System* (OMAS).

### 1.2 Visi & Misi

- **Visi**: Menjadi standar global dalam dokumentasi aturan hukum yang dapat
  dieksekusi mesin (*computable law*).
...
aturan, mulai dari pengumpulan kebutuhan hukum (*requirement gathering*) hingga
...
(Eksekusi Agent) untuk menghindari kekakuan sistem (*software rigidity*).
