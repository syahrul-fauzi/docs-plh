...
- **Objectivity**: Fokus pada fakta teknis dan bisnis, hindari jargon yang tidak
  perlu.
- **Accessibility**: Gunakan bahasa yang dapat dipahami oleh stakeholder lintas
  fungsi (Engineering, Legal, Product).

## 2. Formatting Standards

- **File Naming**: Gunakan `snake_case` untuk nama file (contoh:
  `system_overview.md`).
